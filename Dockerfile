...
# @hasna/calendar self_hosted service — ARM64 / Bun.
# Default CMD runs calendar-serve (cloud / PURE REMOTE per Amendment A1: the
...
EXPOSE 19428
# Fail-closed: calendar-serve /v1 refuses to serve without a cloud DSN + signing
